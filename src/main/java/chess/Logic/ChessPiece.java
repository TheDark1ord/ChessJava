...
public abstract class ChessPiece {
    ...
    // Moves, generated by prev iteration of generateMoves()
    // If an undoMove was called, loaded set to null
    protected List<Move> prevPosibMoves;
    protected BitSet prevAttacked;
    ...
    public void undoMove() {
        if (prevPosibMoves != null) {
            possibleMoves = prevPosibMoves;
            attackedSquares = prevAttacked;
            prevPosibMoves = null;
        } else {
...
class King extends ChessPiece {
    ...
    public void generatePossibleMoves() {
        prevAttacked = attackedSquares;
        prevPosibMoves = possibleMoves;
